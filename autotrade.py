...
def calculate_performance(trades_df):
    ...
    initial_balance = trades_df.iloc[-1]['krw_balance'] + trades_df.iloc[-1]['btc_balance'] * trades_df.iloc[-1][
        'btc_krw_price']
    # 최종 잔고 계산
...
def ai_trading():
    ...
    # 5. 뉴스 헤드라인 가져오기(SERP 계정이 필요해서 사용하지 않을예정.)
